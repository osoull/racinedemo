...
export default function InvestorSidebar() {
  ...
  const menuItems = [
    { path: '/investor', label: 'لوحة التحكم', icon: <LayoutDashboard className="h-5 w-5" /> },
    { path: '/investor/projects', label: 'الفرص الاستثمارية', icon: <Target className="h-5 w-5" /> },
    { path: '/investor/investments', label: 'استثماراتي', icon: <Briefcase className="h-5 w-5" /> },
    { path: '/investor/wallet', label: 'المحفظة', icon: <Wallet className="h-5 w-5" /> },
    { path: '/investor/profile', label: 'الملف الشخصي', icon: <User className="h-5 w-5" /> },
    { path: '/investor/settings', label: 'الإعدادات', icon: <Settings className="h-5 w-5" /> },
  ];
